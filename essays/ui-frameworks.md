...
layout: essay
type: essay
title: "Building Smarter with Bootstrap 5"
date: 2025-10-08
published: true
labels:
  - Bootstrap
...
- **.container / .container-fluid** – wraps and centers content across screen sizes  
- **.row / .col / .col-1 / .offset-1** – structures grid layouts and controls spacing  
- **.justify-content-center / .align-items-center** – aligns items vertically and horizontally  
- **.navbar / .navbar-expand-lg / .nav / .nav-item / .nav-link / .navbar-brand** – builds responsive navigation bars  
- **Utility classes** – such as `.pb-2`, `.justify-content-end`, and `.btn-light` for quick styling  
- **Bootstrap Icons** – easily include vector icons like `<i class="bi bi-twitter-x"></i>`  
- **Forms** – pre-styled inputs and buttons using `.form-control` and `.btn`  
